...
const FloatingWhatsApp = () => {
  ...
  return (
    <Button
      ...
      size="lg"
      className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] hover:bg-[#20BA5A] shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 animate-pulse p-0"
