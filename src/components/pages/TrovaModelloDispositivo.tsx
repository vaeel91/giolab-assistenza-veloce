          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Conoscere il modello esatto del proprio dispositivo è indispensabile per richiede qualsiasi preventivo, noi di Giolab Assemini abbiamo studiato questa sezione per aiutarti a trovarlo, per ogni brand trovi la guida su come trovare il codice modello esatto del tuo dispositivo.                                                            
              </p>
            ...
            {/* Brand Grid */}
            <h2 className="sr-only">Seleziona il brand del tuo dispositivo</h2>
