  ...
  return (
    <>
      <SEOHead
        ...
        description="Contatta Giolab per riparazioni iPhone e smartphone ad Assemini. Telefono: 340 69 70 686 | Email: giolabassemini@gmail.com | Via Carmine 20, Assemini (CA). Preventivo gratuito!"
