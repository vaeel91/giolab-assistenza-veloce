...
export default function ManutenzionePlayStation5() {
  ...
  return <BlogArticleTemplate title="Manutenzione PlayStation 5 - Giolab Assemini" description="Guida PS5: surriscaldamento, metallo liquido, posizione. Manutenzione professionale Assemini. ☎️ 340 69 70 686." keywords="manutenzione PS5, surriscaldamento PlayStation 5, metallo liquido PS5, pulizia PS5 Assemini, riparazione console Cagliari, ventola PS5 rumorosa, PS5 si spegne, assistenza PlayStation Assemini" slug="manutenzione-playstation-5" ogImage="https://giolabriparazioni.it/og-images/manutenzione-playstation-5.jpg" author="GioLab Team" datePublished="2025-01-15" category="Guide" content={articleContent} readingTime={8} />;
}