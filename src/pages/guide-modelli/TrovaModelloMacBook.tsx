...
const TrovaModelloMacBook = () => {
  ...
  const pageTitle = "Come Trovare il Modello MacBook | Guida Completa - GioLab Assemini";
  const pageDescription = "Scopri come identificare il modello esatto del tuo MacBook. Guida completa per trovare il codice modello quando il dispositivo è acceso, spento o danneggiato. GioLab Assemini.";
